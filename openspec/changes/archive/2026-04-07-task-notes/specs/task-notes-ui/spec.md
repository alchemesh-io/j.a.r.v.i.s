...
Clicking the notes button SHALL open a slide-over panel or modal displaying all notes for the selected task. The panel SHALL have a header showing the task title and a close button.
