# Spec: jaar-artifacts-ci

## Purpose

Defines the requirements for the artifacts directory structure, MCP server rewrite under Agent Registry, CI/CD publishing workflow, and Makefile sync targets.
