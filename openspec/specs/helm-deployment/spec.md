...
Defines the requirements for the Helm chart and ArgoCD Application CR that deploy the full J.A.R.V.I.S stack onto a Kubernetes cluster, including persistence, service exposure, and configurability.
