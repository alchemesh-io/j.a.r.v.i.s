...
Defines the requirements for the task board UI page, including task card rendering, CRUD operations, drag-and-drop reordering, calendar navigation, filtering, and form overlays.
