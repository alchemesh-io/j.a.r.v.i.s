...
Defines the requirements for the Makefile-driven local development cluster lifecycle, including Minikube provisioning, ArgoCD setup, application deployment targets, and prerequisite validation.
