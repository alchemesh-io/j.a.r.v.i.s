# Spec: jaar-dashboard-card

## Purpose

Defines the requirements for the Agent Registry dashboard card, JAAR API client, and artifact count display on the J.A.R.V.I.S dashboard.
